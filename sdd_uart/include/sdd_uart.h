...
/**
 * @brief This function is non-blocking and schedules the transmission of a byte.
 * This assumes that that the tx_service has been started and is up-and-running
 * @param uart
 * @param byte
 * @param len
 * @return fp_ret_t
...
fp_ret_t sdd_uart_tx_service_send(sdd_uart_config_t *uart, char *byte,
                                  size_t len);
/**
 * @brief Start a UART receiver service on the current HART. This function should not return
 * 
 * @param uart 
 * @return fp_ret_t 
 */
